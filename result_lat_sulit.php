  ...
  <table border="1" id="content" align="center" style="margin-top: 250px;">
    ...
    <table border="1">
        ...
        <?php
            ...
            $sql = mysqli_query($koneksi,"select * from soal_sulit");
    ...
    <?php
    mysqli_query($koneksi, "UPDATE user set score_lat_sulit = '$score' where User_Name = '$User_Name' ");
    ?>
    
    <a href="sulit.php">Kembali</a>
   </td>
   </tr>
   </table>
