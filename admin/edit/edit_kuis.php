...
$data_edit = mysqli_query($koneksi, "SELECT * FROM t_soal WHERE no ='".$_GET['no']."'");
...
?>
  ...
  <div style="height: 1000px;">
    ...
    <?php
    $query2 = mysqli_query($koneksi, "SELECT * FROM t_soal WHERE no='no'");
    ...
    if(isset($_POST['edit'])){
      ...
      $update = mysqli_query($koneksi, "UPDATE t_soal SET soal = '".$_POST['soal']."',
