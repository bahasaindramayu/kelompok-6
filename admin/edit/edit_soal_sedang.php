...
$data_edit = mysqli_query($koneksi, "SELECT * FROM soal_sedang WHERE no ='".$_GET['no']."'");
...
?>
  ...
  <div style="height: 1000px;">
    <form action="" method="POST">
      <table width="80%" style="margin-top: 200px;" align="center">     
        <tr>
    ...
    <?php
    $query2 = mysqli_query($koneksi, "SELECT * FROM soal_sedang WHERE no='no'");
    ...
    if(isset($_POST['edit'])){
      ...
      $update = mysqli_query($koneksi, "UPDATE soal_sedang SET soal = '".$_POST['soal']."',
