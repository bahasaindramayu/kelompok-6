...
$data_edit = mysqli_query($koneksi, "SELECT * FROM soal_sulit WHERE no ='".$_GET['no']."'");
...
?>
  ...
  <div style="height: 1000px;">
    ...
    <?php
    $query2 = mysqli_query($koneksi, "SELECT * FROM soal_sulit WHERE no='no'");
    ...
    if(isset($_POST['edit'])){
      ...
      $update = mysqli_query($koneksi, "UPDATE soal_sulit SET soal = '".$_POST['soal']."',
