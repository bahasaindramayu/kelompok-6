  ...
  <div style="height: auto; margin-bottom: 40px;" align="center">
    <table id="customers" border="1" width="90%" style="margin-top: 250px;">
      ...
      <?php
      $select=mysqli_query($koneksi, "SELECT * FROM materi_sulit order by Id_materi asc");
      ...
      <tr style="text-align: center;">
        ...
        <td>
            <a href="delete_materi_sulit.php?id_materi=<?php echo $isi['Id_materi']?>"><input width="100px" class="btn btn-primary btn-sm btn-block" type="submit" value="Hapus"></a>
        </td>
      </tr>
      <?php } ?>      
    </table>
    ...
    <table style="margin-bottom: 30px;">
      <tr>
        ...
        <td>  
          <a href="index.php?page=kelola_lat_sulit"><button type="button" class="btn btn-info btn-lg" style="margin-top: 50px;">Kelola Latihan Soal</button></a>
        </td>
      </tr>
    </table>
    ...
    if(isset($_POST['upload'])){
      $insert = mysqli_query($koneksi, "INSERT INTO materi_sulit(id_materi,judul_materi,isi) VALUES
        ('".$_POST['id_materi']."',
         '".$_POST['judul_materi']."',
         '".$_POST['materi']."')");
