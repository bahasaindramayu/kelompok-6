  ...
  <div style="height: auto;" align="center">
    <table id="customers" border="1" width="80%" style="margin-top: 200px; margin-bottom: 50px;">
      ...
      <?php
      $select=mysqli_query($koneksi, "SELECT * FROM t_soal");
      ...
      <tr style="text-align: center;">
        ...
        <td><a style="text-decoration: none;" class="button" href="index.php?page=edit_kuis&no=<?php echo $isi['no']?>">Edit</a><a style="text-decoration: none;" class="button" href="delete_kuis.php?no=<?php echo $isi['no']?>">Hapus</a></td>
      </tr>
      <?php } ?>      
    </table>
    <br><br>
