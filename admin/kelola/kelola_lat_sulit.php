  ...
  <div style="height: auto;" align="center">
    <table id="customers" border="1" width="100%" style="margin-top: 200px; margin-bottom: 50px;">
      ...
      <?php
      $select=mysqli_query($koneksi, "SELECT * FROM soal_sulit");
      ...
      <tr style="text-align: center;">
        ...
        <td><a class="button" href="index.php?page=edit_soal_sulit&no=<?php echo $isi['no']?>">Edit</a><a class="button" href="delete_soal_sulit.php?no=<?php echo $isi['no']?>">Hapus</a></td>
      </tr>
      <?php } ?>      
    </table>
    <br><br>
    <button type="button" class="btn btn-info btn-lg" style="margin-top: 50px; margin-bottom: 200px;"><div class="show_hide">Tambah Soal</div></button>
 ...
 <?php
    ...
    if(isset($_POST['simpan'])){
      $insert = mysqli_query($koneksi, "INSERT INTO soal_sulit VALUES
        ('".$_POST['no']."',
          '".$_POST['soal']."',
          '".$_POST['a']."',
          '".$_POST['b']."',
