  ...
  <div style="height: auto; margin-bottom: 50px;" align="center">
    <table id="customers" border="1" width="80%" style="margin-top: 200px; margin-bottom: 50px;">
      ...
      <tr style="text-align: center;">
        ...
        <td><a class="button" href="index.php?page=edit_pelajaran&id_pelajaran=<?php echo $isi['Id_pelajaran']?>">Edit</a><a class="button" href="delete_pelajaran.php?id_pelajaran=<?php echo $isi['Id_pelajaran']?>">Hapus</a></td>
      </tr>
      <?php } ?>      
    </table>
    <br><br>
